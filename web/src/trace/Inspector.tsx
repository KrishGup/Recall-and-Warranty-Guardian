...
import { criticalNodes, ellipsis, inspectorSub, modelShort, nodeDuration, nodeOutputText, nodeStatus, tokensOf, type Graph } from './model'
...
export function Inspector({ run, graph, sel, onClose, narrow, width, onWidth, onCommit, rtl, theme, now, gate, busy, onCopyPrompt, onCopySpec, onFork }: Props) {
  ...
  const kv: [string, string][] = [
    ...
    ['Attempts', String(rec?.attempts?.length ?? 0)],
